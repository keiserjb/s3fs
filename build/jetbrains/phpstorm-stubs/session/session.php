...
function session_name(
    #[LanguageLevelTypeAware(['8.0' => 'null|string'], default: 'string')]
    $name
)
{
}
 ...
 * @return bool true on success or false on failure.
 */
function session_set_save_handler(\SessionHandlerInterface $sessionhandler, bool $register_shutdown = \true): bool
{
}
/**
...
function session_cache_expire(
    #[LanguageLevelTypeAware(['8.0' => 'null|int'], default: 'int')]
    $value
)
{
}
