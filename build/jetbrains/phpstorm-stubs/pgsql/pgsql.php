...
function pg_connect_poll(
    ...
    $connection = null,
    #[PhpStormStubsElementAvailable(from: '8.0')]
    #[LanguageLevelTypeAware(['8.1' => 'BackdropS3FS\PgSql\Connection'], default: 'resource')]
    $connection
): int
{
}
...
function pg_fetch_result(
    #[LanguageLevelTypeAware(['8.1' => 'BackdropS3FS\PgSql\Result'], default: 'resource')]
    $result,
    #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')]
    $row = 0,
    #[PhpStormStubsElementAvailable(from: '8.0')]
...
function pg_lo_close(
    #[LanguageLevelTypeAware(['8.1' => 'BackdropS3FS\PgSql\Lob'], default: 'resource')]
    $lob
): bool
{
}
 ...
 * <b>pg_connect</b> or <b>pg_pconnect</b>.
 * </p>
 * @param int $verbosity [optional] <p>
...
\define('PGSQL_PIPELINE_SYNC', 10);
\define('PGSQL_PIPELINE_ON', 1);
\define('PGSQL_PIPELINE_OFF', 0);
\define('PGSQL_PIPELINE_ABORTED', 2);
\define('PGSQL_SHOW_CONTEXT_NEVER', 0);
\define('PGSQL_SHOW_CONTEXT_ERRORS', 1);
\define('PGSQL_SHOW_CONTEXT_ALWAYS', 2);
\define('PGSQL_TUPLES_CHUNK', 12);
// End of pgsql v.
