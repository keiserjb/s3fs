...
namespace BackdropS3FS\Sodium;

\define('Sodium\CRYPTO_AEAD_AES256GCM_KEYBYTES', 32);
\define('Sodium\CRYPTO_AEAD_AES256GCM_NSECBYTES', 0);
\define('Sodium\CRYPTO_AEAD_AES256GCM_NPUBBYTES', 12);
\define('Sodium\CRYPTO_AEAD_AES256GCM_ABYTES', 16);
\define('Sodium\CRYPTO_AEAD_CHACHA20POLY1305_KEYBYTES', 32);
\define('Sodium\CRYPTO_AEAD_CHACHA20POLY1305_NSECBYTES', 0);
\define('Sodium\CRYPTO_AEAD_CHACHA20POLY1305_NPUBBYTES', 8);
\define('Sodium\CRYPTO_AEAD_CHACHA20POLY1305_ABYTES', 16);
\define('Sodium\CRYPTO_AUTH_BYTES', 32);
\define('Sodium\CRYPTO_AUTH_KEYBYTES', 32);
\define('Sodium\CRYPTO_BOX_SEALBYTES', 16);
\define('Sodium\CRYPTO_BOX_SECRETKEYBYTES', 32);
\define('Sodium\CRYPTO_BOX_PUBLICKEYBYTES', 32);
\define('Sodium\CRYPTO_BOX_KEYPAIRBYTES', 64);
\define('Sodium\CRYPTO_BOX_MACBYTES', 16);
\define('Sodium\CRYPTO_BOX_NONCEBYTES', 24);
\define('Sodium\CRYPTO_BOX_SEEDBYTES', 32);
\define('Sodium\CRYPTO_KX_BYTES', 32);
\define('Sodium\CRYPTO_KX_PUBLICKEYBYTES', 32);
\define('Sodium\CRYPTO_KX_SECRETKEYBYTES', 32);
\define('Sodium\CRYPTO_GENERICHASH_BYTES', 32);
\define('Sodium\CRYPTO_GENERICHASH_BYTES_MIN', 16);
\define('Sodium\CRYPTO_GENERICHASH_BYTES_MAX', 64);
\define('Sodium\CRYPTO_GENERICHASH_KEYBYTES', 32);
\define('Sodium\CRYPTO_GENERICHASH_KEYBYTES_MIN', 16);
\define('Sodium\CRYPTO_GENERICHASH_KEYBYTES_MAX', 64);
\define('Sodium\CRYPTO_PWHASH_SCRYPTSALSA208SHA256_SALTBYTES', 32);
\define('Sodium\CRYPTO_PWHASH_SCRYPTSALSA208SHA256_STRPREFIX', '$7$');
\define('Sodium\CRYPTO_PWHASH_SCRYPTSALSA208SHA256_OPSLIMIT_INTERACTIVE', 534288);
\define('Sodium\CRYPTO_PWHASH_SCRYPTSALSA208SHA256_MEMLIMIT_INTERACTIVE', 16777216);
\define('Sodium\CRYPTO_PWHASH_SCRYPTSALSA208SHA256_OPSLIMIT_SENSITIVE', 33554432);
\define('Sodium\CRYPTO_PWHASH_SCRYPTSALSA208SHA256_MEMLIMIT_SENSITIVE', 1073741824);
\define('Sodium\CRYPTO_SCALARMULT_BYTES', 32);
\define('Sodium\CRYPTO_SCALARMULT_SCALARBYTES', 32);
\define('Sodium\CRYPTO_SHORTHASH_BYTES', 8);
\define('Sodium\CRYPTO_SHORTHASH_KEYBYTES', 16);
\define('Sodium\CRYPTO_SECRETBOX_KEYBYTES', 32);
\define('Sodium\CRYPTO_SECRETBOX_MACBYTES', 16);
\define('Sodium\CRYPTO_SECRETBOX_NONCEBYTES', 24);
\define('Sodium\CRYPTO_SIGN_BYTES', 64);
\define('Sodium\CRYPTO_SIGN_SEEDBYTES', 32);
\define('Sodium\CRYPTO_SIGN_PUBLICKEYBYTES', 32);
\define('Sodium\CRYPTO_SIGN_SECRETKEYBYTES', 64);
\define('Sodium\CRYPTO_SIGN_KEYPAIRBYTES', 96);
\define('Sodium\CRYPTO_STREAM_KEYBYTES', 32);
\define('Sodium\CRYPTO_STREAM_NONCEBYTES', 24);
\define('Sodium\CRYPTO_PWHASH_OPSLIMIT_INTERACTIVE', 4);
\define('Sodium\CRYPTO_PWHASH_MEMLIMIT_INTERACTIVE', 33554432);
\define('Sodium\CRYPTO_PWHASH_OPSLIMIT_MODERATE', 6);
\define('Sodium\CRYPTO_PWHASH_MEMLIMIT_MODERATE', 134217728);
\define('Sodium\CRYPTO_PWHASH_OPSLIMIT_SENSITIVE', 8);
\define('Sodium\CRYPTO_PWHASH_MEMLIMIT_SENSITIVE', 536870912);
/**
 ...
 * @return string
 */
function crypto_pwhash_scryptsalsa208sha256(int $out_len, string $passwd, string $salt, int $opslimit, int $memlimit): string
{
}
/**
 * Get a formatted password hash (for storage)
