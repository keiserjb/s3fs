 ...
 */
function ftp_append(
    #[LanguageLevelTypeAware(['8.1' => 'BackdropS3FS\FTP\Connection'], default: 'resource')]
    $ftp,
...
function ftp_set_option(
    #[LanguageLevelTypeAware(['8.1' => 'BackdropS3FS\FTP\Connection'], default: 'resource')]
    $ftp,
    #[EV(flags: [\FTP_TIMEOUT_SEC, \FTP_AUTOSEEK, \FTP_USEPASVADDRESS])]
    int $option,
    $value
): bool
{
...
function ftp_get_option(
    #[LanguageLevelTypeAware(['8.1' => 'BackdropS3FS\FTP\Connection'], default: 'resource')]
    $ftp,
    #[EV(flags: [\FTP_TIMEOUT_SEC, \FTP_AUTOSEEK])]
    int $option
): int|bool
{
}
