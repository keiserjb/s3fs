 ...
 */
namespace BackdropS3FS\Vtiful\Kernel;
...
class Excel
{
    public const TYPE_STRING = 0x1;
    public const TYPE_INT = 0x2;
    public const TYPE_DOUBLE = 0x4;
    public const TYPE_TIMESTAMP = 0x8;
    public const SKIP_NONE = 0x0;
    public const SKIP_EMPTY_ROW = 0x1;
    public const SKIP_EMPTY_CELLS = 0x2;
...
class Format
{
    public const UNDERLINE_SINGLE = 0x0;
    public const UNDERLINE_DOUBLE = 0x0;
    public const UNDERLINE_SINGLE_ACCOUNTING = 0x0;
    public const UNDERLINE_DOUBLE_ACCOUNTING = 0x0;
    public const FORMAT_ALIGN_LEFT = 0x0;
    public const FORMAT_ALIGN_CENTER = 0x0;
    public const FORMAT_ALIGN_RIGHT = 0x0;
    public const FORMAT_ALIGN_FILL = 0x0;
    public const FORMAT_ALIGN_JUSTIFY = 0x0;
    public const FORMAT_ALIGN_CENTER_ACROSS = 0x0;
    public const FORMAT_ALIGN_DISTRIBUTED = 0x0;
    public const FORMAT_ALIGN_VERTICAL_TOP = 0x0;
    public const FORMAT_ALIGN_VERTICAL_BOTTOM = 0x0;
    public const FORMAT_ALIGN_VERTICAL_CENTER = 0x0;
    public const FORMAT_ALIGN_VERTICAL_JUSTIFY = 0x0;
    public const FORMAT_ALIGN_VERTICAL_DISTRIBUTED = 0x0;
    public const COLOR_BLACK = 0x0;
    public const COLOR_BLUE = 0x0;
    public const COLOR_BROWN = 0x0;
    public const COLOR_CYAN = 0x0;
    public const COLOR_GRAY = 0x0;
    public const COLOR_GREEN = 0x0;
    public const COLOR_LIME = 0x0;
    public const COLOR_MAGENTA = 0x0;
    public const COLOR_NAVY = 0x0;
    public const COLOR_ORANGE = 0x0;
    public const COLOR_PINK = 0x0;
    public const COLOR_PURPLE = 0x0;
    public const COLOR_RED = 0x0;
    public const COLOR_SILVER = 0x0;
    public const COLOR_WHITE = 0x0;
    public const COLOR_YELLOW = 0x0;
    public const PATTERN_NONE = 0x0;
    public const PATTERN_SOLID = 0x0;
    public const PATTERN_MEDIUM_GRAY = 0x0;
    public const PATTERN_DARK_GRAY = 0x0;
    public const PATTERN_LIGHT_GRAY = 0x0;
    public const PATTERN_DARK_HORIZONTAL = 0x0;
    public const PATTERN_DARK_VERTICAL = 0x0;
    public const PATTERN_DARK_DOWN = 0x0;
    public const PATTERN_DARK_UP = 0x0;
    public const PATTERN_DARK_GRID = 0x0;
    public const PATTERN_DARK_TRELLIS = 0x0;
    public const PATTERN_LIGHT_HORIZONTAL = 0x0;
    public const PATTERN_LIGHT_VERTICAL = 0x0;
    public const PATTERN_LIGHT_DOWN = 0x0;
    public const PATTERN_LIGHT_UP = 0x0;
    public const PATTERN_LIGHT_GRID = 0x0;
    public const PATTERN_LIGHT_TRELLIS = 0x0;
    public const PATTERN_GRAY_125 = 0x0;
    public const PATTERN_GRAY_0625 = 0x0;
    public const BORDER_THIN = 0x0;
    public const BORDER_MEDIUM = 0x0;
    public const BORDER_DASHED = 0x0;
    public const BORDER_DOTTED = 0x0;
    public const BORDER_THICK = 0x0;
    public const BORDER_DOUBLE = 0x0;
    public const BORDER_HAIR = 0x0;
    public const BORDER_MEDIUM_DASHED = 0x0;
    public const BORDER_DASH_DOT = 0x0;
    public const BORDER_MEDIUM_DASH_DOT = 0x0;
    public const BORDER_DASH_DOT_DOT = 0x0;
    public const BORDER_MEDIUM_DASH_DOT_DOT = 0x0;
    public const BORDER_SLANT_DASH_DOT = 0x0;
    /**
     * Format constructor.
     *
