...
\define('VIR_DOMAIN_AFFECT_CURRENT', \VIR_DOMAIN_AFFECT_CURRENT);
...
\define('VIR_NETWORKS_ALL', \VIR_NETWORKS_ACTIVE | \VIR_NETWORKS_INACTIVE);
...
\define('VIR_DOMAIN_BLOCK_PULL_BANDWIDTH_BYTES', 128);
...
\define('VIR_CONNECT_GET_ALL_DOMAINS_STATS_OTHER', 4);
\define('VIR_CONNECT_GET_ALL_DOMAINS_STATS_PAUSED', 8);
\define('VIR_CONNECT_GET_ALL_DOMAINS_STATS_PERSISTENT', 16);
\define('VIR_CONNECT_GET_ALL_DOMAINS_STATS_RUNNING', 32);
\define('VIR_CONNECT_GET_ALL_DOMAINS_STATS_SHUTOFF', 64);
\define('VIR_CONNECT_GET_ALL_DOMAINS_STATS_TRANSIENT', 128);
\define('VIR_CONNECT_GET_ALL_DOMAINS_STATS_ENFORCE_STATS', 2 ^ 31);
...
\define('VIR_DOMAIN_INTERFACE_ADDRESSES_SRC_ARP', \VIR_DOMAIN_INTERFACE_ADDRESSES_SRC_LEASE);
\define('VIR_CONNECT_FLAG_SOUNDHW_GET_NAMES', 1);
\define('VIR_KEYCODE_SET_LINUX', 0);
\define('VIR_KEYCODE_SET_XT', 1);
\define('VIR_KEYCODE_SET_ATSET1', 6);
\define('VIR_KEYCODE_SET_ATSET2', 2);
\define('VIR_KEYCODE_SET_ATSET3', 3);
\define('VIR_KEYCODE_SET_OSX', 4);
\define('VIR_KEYCODE_SET_XT_KBD', 5);
\define('VIR_KEYCODE_SET_USB', 6);
\define('VIR_KEYCODE_SET_WIN32', 7);
\define('VIR_KEYCODE_SET_RFB', 8);
\define('VIR_DOMAIN_UNDEFINE_MANAGED_SAVE', 1);
\define('VIR_DOMAIN_UNDEFINE_SNAPSHOTS_METADATA', 2);
\define('VIR_DOMAIN_UNDEFINE_NVRAM', 4);
\define('VIR_DOMAIN_UNDEFINE_KEEP_NVRAM', 8);
/* Connect functions */
/**
 ...
 * @since 0.4.1(-1)
 */
function libvirt_connect(string $url, bool $readonly = \true, array $credentials)
{
}
/**
 ...
 * @since 0.4.2
 */
function libvirt_domain_send_pointer_event($res, string $server, int $pos_x, int $pos_y, int $clicked, bool $release = \true): bool
{
}
/**
