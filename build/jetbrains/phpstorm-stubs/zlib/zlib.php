...
function deflate_add(
    #[LanguageLevelTypeAware(["8.0" => "DeflateContext"], default: "resource")]
    $context,
    string $data,
...
function inflate_add(
    #[LanguageLevelTypeAware(["8.0" => "InflateContext"], default: "resource")]
    $context,
    string $data,
    int $flush_mode = \ZLIB_SYNC_FLUSH
): string|false
 ...
 * @since 8.0
 */
\class_alias('BackdropS3FS\InflateContext', 'InflateContext', \false);
/**
 * @since 8.0
 */
 ...
 * @since 8.0
 */
\class_alias('BackdropS3FS\DeflateContext', 'DeflateContext', \false);
