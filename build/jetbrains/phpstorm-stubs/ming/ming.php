...
// Start of ming v.
\class_alias('BackdropS3FS\SWFShape', 'SWFShape', \false);
class SWFFill
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFFill', 'SWFFill', \false);
class SWFGradient
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFGradient', 'SWFGradient', \false);
class SWFBitmap
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFBitmap', 'SWFBitmap', \false);
class SWFText
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFText', 'SWFText', \false);
class SWFTextField
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFTextField', 'SWFTextField', \false);
class SWFFont
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFFont', 'SWFFont', \false);
...
\class_alias('BackdropS3FS\SWFDisplayItem', 'SWFDisplayItem', \false);
class SWFMovie
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFMovie', 'SWFMovie', \false);
class SWFButton
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFButton', 'SWFButton', \false);
class SWFAction
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFAction', 'SWFAction', \false);
class SWFMorph
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFMorph', 'SWFMorph', \false);
class SWFSprite
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFSprite', 'SWFSprite', \false);
class SWFSound
{
    public function __construct()
    {
...
\class_alias('BackdropS3FS\SWFSound', 'SWFSound', \false);
class SWFFontChar
{
    public function addChars()
    {
...
\class_alias('BackdropS3FS\SWFFontChar', 'SWFFontChar', \false);
...
\class_alias('BackdropS3FS\SWFSoundInstance', 'SWFSoundInstance', \false);
...
\class_alias('BackdropS3FS\SWFVideoStream', 'SWFVideoStream', \false);
/**
 * Set cubic threshold
