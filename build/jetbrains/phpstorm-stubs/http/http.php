...
\class_alias('BackdropS3FS\HttpException', 'HttpException', \false);
class HttpRuntimeException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpRuntimeException', 'HttpRuntimeException', \false);
class HttpInvalidParamException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpInvalidParamException', 'HttpInvalidParamException', \false);
class HttpHeaderException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpHeaderException', 'HttpHeaderException', \false);
class HttpMalformedHeadersException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpMalformedHeadersException', 'HttpMalformedHeadersException', \false);
class HttpRequestMethodException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpRequestMethodException', 'HttpRequestMethodException', \false);
class HttpMessageTypeException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpMessageTypeException', 'HttpMessageTypeException', \false);
class HttpEncodingException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpEncodingException', 'HttpEncodingException', \false);
class HttpRequestException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpRequestException', 'HttpRequestException', \false);
class HttpRequestPoolException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpRequestPoolException', 'HttpRequestPoolException', \false);
class HttpSocketException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpSocketException', 'HttpSocketException', \false);
class HttpResponseException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpResponseException', 'HttpResponseException', \false);
class HttpUrlException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpUrlException', 'HttpUrlException', \false);
class HttpQueryStringException extends \HttpException
{
}
\class_alias('BackdropS3FS\HttpQueryStringException', 'HttpQueryStringException', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpdeflatestream.php
 */
\class_alias('BackdropS3FS\HttpDeflateStream', 'HttpDeflateStream', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpinflatestream.php
 */
\class_alias('BackdropS3FS\HttpInflateStream', 'HttpInflateStream', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpmessage.php
 */
\class_alias('BackdropS3FS\HttpMessage', 'HttpMessage', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpquerystring.php
 */
\class_alias('BackdropS3FS\HttpQueryString', 'HttpQueryString', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httprequest.php
 */
\class_alias('BackdropS3FS\HttpRequest', 'HttpRequest', \false);
...
\class_alias('BackdropS3FS\HttpRequestDataShare', 'HttpRequestDataShare', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httprequestpool.php
 */
\class_alias('BackdropS3FS\HttpRequestPool', 'HttpRequestPool', \false);
/**
 ...
 * @link https://php.net/manual/en/class.httpresponse.php
 */
\class_alias('BackdropS3FS\HttpResponse', 'HttpResponse', \false);
class HttpUtil
{
    /**
...
\class_alias('BackdropS3FS\HttpUtil', 'HttpUtil', \false);
/**
