 ...
 * created using:
 */
\class_alias('BackdropS3FS\classObj', 'classObj', \false);
/**
 ...
 * Instance of clusterObj is always embedded inside the `layerObj`_.
 */
\class_alias('BackdropS3FS\clusterObj', 'clusterObj', \false);
/**
 ...
 * Instances of colorObj are always embedded inside other classes.
 */
\class_alias('BackdropS3FS\colorObj', 'colorObj', \false);
...
\class_alias('BackdropS3FS\errorObj', 'errorObj', \false);
/**
 ...
 * $oLayer->grid->set("labelformat", "DDMMSS");
 */
\class_alias('BackdropS3FS\gridObj', 'gridObj', \false);
/**
 ...
 * echo "Key: ".$key." value: ".$hashTable->get($key)."<br/>";
 */
\class_alias('BackdropS3FS\hashTableObj', 'hashTableObj', \false);
/**
 ...
 * Instances of imageObj are always created by the `mapObj`_ class methods.
 */
\class_alias('BackdropS3FS\imageObj', 'imageObj', \false);
...
\class_alias('BackdropS3FS\labelcacheMemberObj', 'labelcacheMemberObj', \false);
...
\class_alias('BackdropS3FS\labelcacheObj', 'labelcacheObj', \false);
/**
 ...
 * labelObj are always embedded inside other classes.
 */
\class_alias('BackdropS3FS\labelObj', 'labelObj', \false);
/**
 ...
 * layer created.
 */
\class_alias('BackdropS3FS\layerObj', 'layerObj', \false);
/**
 ...
 * Instances of legendObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('BackdropS3FS\legendObj', 'legendObj', \false);
final class lineObj
{
    /**
     * read-only
...
\class_alias('BackdropS3FS\lineObj', 'lineObj', \false);
final class mapObj
{
    /**
     * @var float
...
\class_alias('BackdropS3FS\mapObj', 'mapObj', \false);
/**
 ...
 * No constructor available (coming soon, see ticket 979)
 */
\class_alias('BackdropS3FS\outputformatObj', 'outputformatObj', \false);
...
\class_alias('BackdropS3FS\OwsrequestObj', 'OwsrequestObj', \false);
...
\class_alias('BackdropS3FS\pointObj', 'pointObj', \false);
...
\class_alias('BackdropS3FS\projectionObj', 'projectionObj', \false);
/**
 ...
 * `mapObj`_.
 */
\class_alias('BackdropS3FS\querymapObj', 'querymapObj', \false);
/**
 ...
 * also be created with:
 */
\class_alias('BackdropS3FS\rectObj', 'rectObj', \false);
/**
 ...
 * Instances of referenceMapObj are always embedded inside the `mapObj`_.
 */
\class_alias('BackdropS3FS\referenceMapObj', 'referenceMapObj', \false);
...
\class_alias('BackdropS3FS\resultObj', 'resultObj', \false);
/**
 ...
 * Instances of scalebarObj are always embedded inside the `mapObj`_.
 */
\class_alias('BackdropS3FS\scalebarObj', 'scalebarObj', \false);
...
\class_alias('BackdropS3FS\shapefileObj', 'shapefileObj', \false);
...
\class_alias('BackdropS3FS\shapeObj', 'shapeObj', \false);
/**
 ...
 * Instances of styleObj are always embedded inside a `classObj`_ or `labelObj`_.
 */
\class_alias('BackdropS3FS\styleObj', 'styleObj', \false);
...
\class_alias('BackdropS3FS\symbolObj', 'symbolObj', \false);
/**
 ...
 * Instances of webObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('BackdropS3FS\webObj', 'webObj', \false);
