 ...
 * @link https://secure.php.net/manual/en/class.zmq.php
 */
\class_alias('BackdropS3FS\ZMQ', 'ZMQ', \false);
/**
 * Class ZMQContext
...
class ZMQContext
{
     ...
     */
    public function __construct($io_threads = 1, $is_persistent = \true)
    {
    }
    /**
     * (PECL zmq &gt;= 1.0.4)
 ...
 * @link https://secure.php.net/manual/en/class.zmqcontext.php
 */
\class_alias('BackdropS3FS\ZMQContext', 'ZMQContext', \false);
/**
 * Class ZMQSocket
 ...
 * @link https://secure.php.net/manual/en/class.zmqsocket.php
 */
\class_alias('BackdropS3FS\ZMQSocket', 'ZMQSocket', \false);
/**
 * Class ZMQPoll
 ...
 * @link https://secure.php.net/manual/en/class.zmqpoll.php
 */
\class_alias('BackdropS3FS\ZMQPoll', 'ZMQPoll', \false);
/**
 * Class ZMQDevice
 ...
 * @link https://secure.php.net/manual/en/class.zmqdevice.php
 */
\class_alias('BackdropS3FS\ZMQDevice', 'ZMQDevice', \false);
class ZMQException extends \Exception
{
}
\class_alias('BackdropS3FS\ZMQException', 'ZMQException', \false);
class ZMQContextException extends \ZMQException
{
}
\class_alias('BackdropS3FS\ZMQContextException', 'ZMQContextException', \false);
class ZMQSocketException extends \ZMQException
{
}
\class_alias('BackdropS3FS\ZMQSocketException', 'ZMQSocketException', \false);
class ZMQPollException extends \ZMQException
{
}
\class_alias('BackdropS3FS\ZMQPollException', 'ZMQPollException', \false);
class ZMQDeviceException extends \ZMQException
{
}
\class_alias('BackdropS3FS\ZMQDeviceException', 'ZMQDeviceException', \false);
