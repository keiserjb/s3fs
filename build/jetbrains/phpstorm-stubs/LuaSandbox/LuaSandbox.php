 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BackdropS3FS\LuaSandbox', 'LuaSandbox', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BackdropS3FS\LuaSandboxFunction', 'LuaSandboxFunction', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BackdropS3FS\LuaSandboxError', 'LuaSandboxError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BackdropS3FS\LuaSandboxRuntimeError', 'LuaSandboxRuntimeError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BackdropS3FS\LuaSandboxFatalError', 'LuaSandboxFatalError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BackdropS3FS\LuaSandboxErrorError', 'LuaSandboxErrorError', \false);
/**
 ...
 * @see LuaSandbox::setMemoryLimit()
 */
\class_alias('BackdropS3FS\LuaSandboxMemoryError', 'LuaSandboxMemoryError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('BackdropS3FS\LuaSandboxSyntaxError', 'LuaSandboxSyntaxError', \false);
/**
 ...
 * @see LuaSandbox::setCPULimit()
 */
\class_alias('BackdropS3FS\LuaSandboxTimeoutError', 'LuaSandboxTimeoutError', \false);
