...
\class_alias('BackdropS3FS\UV', 'UV', \false);
abstract class UVStream extends \UV
{
}
\class_alias('BackdropS3FS\UVStream', 'UVStream', \false);
class UVTcp extends \UVStream
{
}
\class_alias('BackdropS3FS\UVTcp', 'UVTcp', \false);
class UVUdp extends \UV
{
}
\class_alias('BackdropS3FS\UVUdp', 'UVUdp', \false);
class UVPipe extends \UVStream
{
}
\class_alias('BackdropS3FS\UVPipe', 'UVPipe', \false);
class UVIdle extends \UV
{
}
\class_alias('BackdropS3FS\UVIdle', 'UVIdle', \false);
class UVTimer extends \UV
{
}
\class_alias('BackdropS3FS\UVTimer', 'UVTimer', \false);
class UVAsync extends \UV
{
}
\class_alias('BackdropS3FS\UVAsync', 'UVAsync', \false);
class UVAddrinfo extends \UV
{
}
\class_alias('BackdropS3FS\UVAddrinfo', 'UVAddrinfo', \false);
class UVProcess extends \UV
{
}
\class_alias('BackdropS3FS\UVProcess', 'UVProcess', \false);
class UVPrepare extends \UV
{
}
\class_alias('BackdropS3FS\UVPrepare', 'UVPrepare', \false);
class UVCheck extends \UV
{
}
\class_alias('BackdropS3FS\UVCheck', 'UVCheck', \false);
class UVWork extends \UV
{
}
\class_alias('BackdropS3FS\UVWork', 'UVWork', \false);
class UVFs extends \UV
{
}
\class_alias('BackdropS3FS\UVFs', 'UVFs', \false);
class UVFsEvent extends \UV
{
}
\class_alias('BackdropS3FS\UVFsEvent', 'UVFsEvent', \false);
class UVTty extends \UVStream
{
}
\class_alias('BackdropS3FS\UVTty', 'UVTty', \false);
class UVFsPoll extends \UV
{
}
\class_alias('BackdropS3FS\UVFsPoll', 'UVFsPoll', \false);
class UVPoll extends \UV
{
}
\class_alias('BackdropS3FS\UVPoll', 'UVPoll', \false);
class UVSignal extends \UV
{
}
\class_alias('BackdropS3FS\UVSignal', 'UVSignal', \false);
class UVLoop
{
}
\class_alias('BackdropS3FS\UVLoop', 'UVLoop', \false);
abstract class UVSockAddr
{
}
\class_alias('BackdropS3FS\UVSockAddr', 'UVSockAddr', \false);
class UVSockAddrIPv4 extends \UVSockAddr
{
}
\class_alias('BackdropS3FS\UVSockAddrIPv4', 'UVSockAddrIPv4', \false);
class UVSockAddrIPv6 extends \UVSockAddr
{
}
\class_alias('BackdropS3FS\UVSockAddrIPv6', 'UVSockAddrIPv6', \false);
class UVLock
{
}
\class_alias('BackdropS3FS\UVLock', 'UVLock', \false);
class UVStdio
{
}
\class_alias('BackdropS3FS\UVStdio', 'UVStdio', \false);
