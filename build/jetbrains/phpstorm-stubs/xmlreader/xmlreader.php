...
class XMLReader
{
     ...
     */
    #[TentativeType]
    public function getAttributeNo(
     ...
     */
    #[TentativeType]
    public function getParserProperty(
        #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')]
        $property
    ): bool
    {
     ...
     */
    #[TentativeType]
    public function moveToAttributeNo(
        #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')]
        $index
    ): bool
    {
     ...
     */
    #[TentativeType]
    public function setRelaxNGSchema(
        #[LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')]
        $filename
    ): bool
    {
     ...
     */
    #[TentativeType]
    public function setRelaxNGSchemaSource(
        #[LanguageLevelTypeAware(['8.0' => 'string|null'], default: '')]
        $source
    ): bool
    {
 ...
 * @property-read string $xmlLang The xml:lang scope which the node resides
 */
\class_alias('BackdropS3FS\XMLReader', 'XMLReader', \false);
