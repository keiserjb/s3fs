 ...
 * mysqli_sql_exception
 */
\class_alias('BackdropS3FS\mysqli_sql_exception', 'mysqli_sql_exception', \false);
/**
 * MySQLi Driver.
 ...
 * @link https://php.net/manual/en/class.mysqli-driver.php
 */
\class_alias('BackdropS3FS\mysqli_driver', 'mysqli_driver', \false);
/**
...
class mysqli
{
    ...
    public function store_result(
        #[Deprecated(since: '8.4'), LanguageLevelTypeAware(['8.0' => 'int'], default: '')]
        $mode = 0
    ): \mysqli_result|false
    {
    }
 ...
 * @link https://php.net/manual/en/class.mysqli.php
 */
\class_alias('BackdropS3FS\mysqli', 'mysqli', \false);
/**
 ...
 * @link https://php.net/manual/en/class.mysqli-warning.php
 */
\class_alias('BackdropS3FS\mysqli_warning', 'mysqli_warning', \false);
/**
 ...
 * @link https://php.net/manual/en/class.mysqli-result.php
 */
\class_alias('BackdropS3FS\mysqli_result', 'mysqli_result', \false);
/**
 ...
 * @link https://php.net/manual/en/class.mysqli-stmt.php
 */
\class_alias('BackdropS3FS\mysqli_stmt', 'mysqli_stmt', \false);
/**
