 ...
 * Class gnupg
 */
\class_alias('BackdropS3FS\gnupg', 'gnupg', \false);
...
\class_alias('BackdropS3FS\gnupg_keylistiterator', 'gnupg_keylistiterator', \false);
/**
...
function gnupg_setsignmode(
    $res,
    #[ExpectedValues([\GNUPG_SIG_MODE_NORMAL | \GNUPG_SIG_MODE_DETACH | \GNUPG_SIG_MODE_CLEAR])]
    $signmode
)
{
}
...
function gnupg_seterrormode(
    $res,
    #[ExpectedValues([\GNUPG_ERROR_WARNING | \GNUPG_ERROR_EXCEPTION | \GNUPG_ERROR_SILENT])]
    $errnmode
)
{
}
