...
// Start of Zend Extensions
\class_alias('BackdropS3FS\ZendAPI_Queue', 'ZendAPI_Queue', \false);
/**
 ...
 * For simplicity, a job can be added directly to a queue and without creating an instant of a Queue object
 */
\class_alias('BackdropS3FS\ZendAPI_Job', 'ZendAPI_Job', \false);
/**
...
\class_alias('BackdropS3FS\java', 'java', \false);
class JavaException
{
    /**
...
\class_alias('BackdropS3FS\JavaException', 'JavaException', \false);
