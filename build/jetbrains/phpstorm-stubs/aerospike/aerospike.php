...
class Aerospike
{
     ...
     */
    public function __construct($config, $persistent_connection = \true, array $options = [])
    {
    }
    /**
    ...
    */
    ...
    // can perform data admin functions that do not involve user admin
    ...
    // can perform sysadmin functions that do not involve user admin
    /*
            // TODO:
            // security methods
 ...
 * @author Robert Marks <robert@aerospike.com>
 */
\class_alias('BackdropS3FS\Aerospike', 'Aerospike', \false);
