...
use BackdropS3FS\JetBrains\PhpStorm\Internal\ReturnTypeContract as TypeContract;
...
function round(
    int|float $num,
    int $precision = 0,
    #[LanguageLevelTypeAware(['8.4' => 'RoundingMode|int'], default: 'int')]
    $mode = 0
): float
{
}
...
#[Pure(\true)]
function microtime(
    #[TypeContract(true: "float", false: "string")]
    bool $as_float = \false
): string|float
{
}
...
function gettimeofday(
    #[TypeContract(true: "float", false: "int[]")]
    bool $as_float = \false
): array|float
{
}
