...
function array_key_exists(
    $key,
    #[LanguageLevelTypeAware(["8.0" => "array"], default: "array|ArrayObject")]
    $array
): bool
{
}
...
function assert(
    ...
    #[LanguageLevelTypeAware(['7.0' => 'Throwable|string|null'], default: 'string')]
    $description = null
): bool
{
}
 ...
 * @since 7.0
 */
\class_alias('BackdropS3FS\AssertionError', 'AssertionError', \false);
/**
...
function version_compare(
    string $version1,
    string $version2,
    #[ExpectedValues(values: ["<", "lt", "<=", "le", ">", "gt", ">=", "ge", "==", "=", "eq", "!=", "<>", "ne"])]
    ?string $operator
): int|bool
{
}
