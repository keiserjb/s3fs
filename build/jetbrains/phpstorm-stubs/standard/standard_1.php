...
function pathinfo(
    string $path,
    #[ExpectedValues(flags: [\PATHINFO_DIRNAME, \PATHINFO_BASENAME, \PATHINFO_EXTENSION, \PATHINFO_FILENAME])]
...
function strip_tags(
    string $string,
    #[LanguageLevelTypeAware(["7.4" => "string[]|string|null"], default: "string|null")]
    $allowed_tags = null
): string
{
}
