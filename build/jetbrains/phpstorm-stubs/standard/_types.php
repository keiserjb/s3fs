 ...
 * @template-implements Iterator<TKey, TYield>
 */
\class_alias('BackdropS3FS\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('BackdropS3FS\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace BackdropS3FS\___PHPSTORM_HELPERS;
