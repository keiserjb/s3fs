...
\class_alias('BackdropS3FS\__PHP_Incomplete_Class', '__PHP_Incomplete_Class', \false);
...
\class_alias('BackdropS3FS\php_user_filter', 'php_user_filter', \false);
/**
 * @since 8.4
 */
 ...
 * @since 8.4
 */
\class_alias('BackdropS3FS\StreamBucket', 'StreamBucket', \false);
/**
 ...
 * Instances of Directory are created by calling the dir() function, not by the new operator.
 */
\class_alias('BackdropS3FS\Directory', 'Directory', \false);
/**
 ...
 */
#[Pure]
function htmlspecialchars(string $string, int $flags = \ENT_QUOTES | \ENT_SUBSTITUTE, ?string $encoding = null, bool $double_encode = \true): string
{
}
/**
...
function phpinfo(
    #[ExpectedValues(flags: [\INFO_GENERAL, \INFO_CREDITS, \INFO_CONFIGURATION, \INFO_MODULES, \INFO_ENVIRONMENT, \INFO_VARIABLES, \INFO_LICENSE, \INFO_ALL])]
    int $flags = \INFO_ALL
): bool
{
}
