...
function openssl_pkey_free(
    #[LanguageLevelTypeAware(["8.0" => "OpenSSLAsymmetricKey"], default: "resource")]
    $key
): void
{
}
...
function openssl_pkey_export(
    #[LanguageLevelTypeAware(['8.0' => 'OpenSSLAsymmetricKey|OpenSSLCertificate|array|string'], default: 'resource|array|string')]
    $key,
    &$output,
    ?string $passphrase,
    ?array $options
...
function openssl_x509_free(
    #[LanguageLevelTypeAware(["8.0" => "OpenSSLCertificate"], default: "resource|string")]
    $certificate
): void
{
}
 ...
 */
#[LanguageLevelTypeAware(["8.0" => "OpenSSLCertificateSigningRequest|false", "8.2" => "OpenSSLCertificateSigningRequest|bool"], default: "resource|false")]
...
function openssl_csr_export(
    #[LanguageLevelTypeAware(["8.0" => "OpenSSLCertificateSigningRequest|string"], default: "resource|string")]
    $csr,
    &$output,
    bool $no_text = \true
): bool
...
function openssl_csr_sign(
    #[LanguageLevelTypeAware(["8.0" => "OpenSSLCertificateSigningRequest|string"], default: "resource|string")]
    $csr,
    #[LanguageLevelTypeAware(["8.0" => "OpenSSLCertificate|string|null"], default: "resource|string|null")]
    $ca_certificate,
    #[LanguageLevelTypeAware(["8.0" => "OpenSSLAsymmetricKey|OpenSSLCertificate|array|string"], default: "resource|array|string")]
    $private_key,
    int $days,
...
function openssl_decrypt(
    ...
    string $iv = "",
    #[PhpStormStubsElementAvailable(from: '7.1')]
    #[LanguageLevelTypeAware(['8.1' => 'string|null'], default: 'string')]
    $tag = null,
    #[PhpStormStubsElementAvailable(from: '7.1')]
    string $aad = ""
): string|false
...
function openssl_pkcs7_decrypt(
    ...
    string $output_filename,
    $certificate,
    #[LanguageLevelTypeAware(['8.0' => 'OpenSSLAsymmetricKey|OpenSSLCertificate|array|string|null'], default: 'resource|array|string|null')]
    $private_key
): bool
{
}
...
function openssl_pkcs7_encrypt(
    string $input_filename,
    string $output_filename,
    #[LanguageLevelTypeAware(["8.0" => "OpenSSLCertificate|array|string"], default: "resource|array|string")]
    $certificate,
    ?array $headers,
    int $flags = 0,
 ...
 * @since 8.0
 */
\class_alias('BackdropS3FS\OpenSSLCertificate', 'OpenSSLCertificate', \false);
/**
 * @since 8.0
 */
 ...
 * @since 8.0
 */
\class_alias('BackdropS3FS\OpenSSLCertificateSigningRequest', 'OpenSSLCertificateSigningRequest', \false);
/**
 * @since 8.0
 */
 ...
 * @since 8.0
 */
\class_alias('BackdropS3FS\OpenSSLAsymmetricKey', 'OpenSSLAsymmetricKey', \false);
