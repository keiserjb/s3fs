 ...
 * Ev is a singleton providing access to the default loop and to some common operations.
 */
\class_alias('BackdropS3FS\Ev', 'Ev', \false);
/**
 * Class EvWatcher
 */
 ...
 * Class EvWatcher
 */
\class_alias('BackdropS3FS\EvWatcher', 'EvWatcher', \false);
/**
 * Class EvCheck
 *
 ...
 * before other EvCheck watchers did their job.
 */
\class_alias('BackdropS3FS\EvCheck', 'EvCheck', \false);
/**
 * Class EvChild
 *
 ...
 * It is allowed to register EvChild watchers in the default loop only.
 */
\class_alias('BackdropS3FS\EvChild', 'EvChild', \false);
/**
 * Class EvEmbed
 *
 ...
 * Used to embed one event loop into another.
 */
\class_alias('BackdropS3FS\EvEmbed', 'EvEmbed', \false);
/**
 * Class EvIo
 *
 ...
 * Always consider using non-blocking mode.
 */
\class_alias('BackdropS3FS\EvIo', 'EvIo', \false);
/**
 * Class EvPeriodic
 *
 ...
 * recursively).
 */
\class_alias('BackdropS3FS\EvPeriodic', 'EvPeriodic', \false);
/**
 * Class EvPrepare
 *
 * EvPrepare and EvCheck watchers are usually used in pairs. EvPrepare watchers get invoked before the process blocks,
 ...
 * before other EvCheck watchers did their job.
 */
\class_alias('BackdropS3FS\EvPrepare', 'EvPrepare', \false);
/**
 * Class EvSignal
 *
 ...
 * all the signals can be blocked in an EvCheck watcher and unblocked in a EvPrepare watcher.
 */
\class_alias('BackdropS3FS\EvSignal', 'EvSignal', \false);
/**
 * Class EvStat
 *
 ...
 * notifications, this can be resource-intensive.
 */
\class_alias('BackdropS3FS\EvStat', 'EvStat', \false);
/**
 * Class EvTimer
 *
 ...
 * iteration.
 */
\class_alias('BackdropS3FS\EvTimer', 'EvTimer', \false);
/**
 * Class EvIdle
 *
 ...
 * for new events.
 */
\class_alias('BackdropS3FS\EvIdle', 'EvIdle', \false);
/**
 * Class EvFork
 *
 ...
 * fork handlers will be invoked, too.
 */
\class_alias('BackdropS3FS\EvFork', 'EvFork', \false);
/**
 * Class EvLoop
 *
 ...
 * EvLoop::defaultLoop() method.
 */
\class_alias('BackdropS3FS\EvLoop', 'EvLoop', \false);
