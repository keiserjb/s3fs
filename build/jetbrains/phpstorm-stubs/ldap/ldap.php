...
use BackdropS3FS\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware as PhpVersionAware;
use BackdropS3FS\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable as Available;
use LDAP\Result;
/**
...
function ldap_exop_passwd(
    #[PhpVersionAware(['8.1' => 'BackdropS3FS\LDAP\Connection'], default: 'resource')]
    $ldap,
...
function ldap_parse_exop(
    #[PhpVersionAware(['8.1' => 'BackdropS3FS\LDAP\Connection'], default: 'resource')]
    $ldap,
    #[PhpVersionAware(['8.1' => 'BackdropS3FS\LDAP\Result'], default: 'resource')]
    $result,
...
function ldap_next_entry(
    #[PhpVersionAware(['8.1' => 'BackdropS3FS\LDAP\Connection'], default: 'resource')]
    $ldap,
    #[PhpVersionAware(['8.1' => 'BackdropS3FS\LDAP\ResultEntry'], default: 'resource')]
    $entry
)
{
}
