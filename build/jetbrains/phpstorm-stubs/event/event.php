 ...
 * @see https://php.net/manual/en/class.event.php
 */
\class_alias('BackdropS3FS\Event', 'Event', \false);
//  The EventBase class
/**
 * EventBase.
 ...
 * @see https://php.net/manual/en/class.eventbase.php
 */
\class_alias('BackdropS3FS\EventBase', 'EventBase', \false);
 ...
 * @see https://php.net/manual/en/class.eventbuffer.php
 */
\class_alias('BackdropS3FS\EventBuffer', 'EventBuffer', \false);
 ...
 * @see https://php.net/manual/en/class.eventbufferevent.php
 */
\class_alias('BackdropS3FS\EventBufferEvent', 'EventBufferEvent', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventconfig.php
 */
\class_alias('BackdropS3FS\EventConfig', 'EventConfig', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventdnsbase.php
 */
\class_alias('BackdropS3FS\EventDnsBase', 'EventDnsBase', \false);
// The EventHttp class
/**
 * EventHttp.
 ...
 * @see https://secure.php.net/manual/en/class.eventhttp.php
 */
\class_alias('BackdropS3FS\EventHttp', 'EventHttp', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventhttpconnection.php
 */
\class_alias('BackdropS3FS\EventHttpConnection', 'EventHttpConnection', \false);
...
// The EventHttpRequest class
\class_alias('BackdropS3FS\EventHttpRequest', 'EventHttpRequest', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventlistener.php
 */
\class_alias('BackdropS3FS\EventListener', 'EventListener', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventsslcontext.php
 */
\class_alias('BackdropS3FS\EventSslContext', 'EventSslContext', \false);
// The EventUtil class
/**
 * EventUtil.
 ...
 * @see https://secure.php.net/manual/en/class.eventutil.php
 */
\class_alias('BackdropS3FS\EventUtil', 'EventUtil', \false);
