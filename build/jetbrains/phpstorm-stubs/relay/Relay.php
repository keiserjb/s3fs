...
class Relay
{
     ...
     * @param  array  $context
     */
    #[\BackdropS3FS\Relay\Attributes\Server]
     ...
     * @return bool
     */
    #[\BackdropS3FS\Relay\Attributes\Local]
     ...
     * @return mixed
     */
    #[\BackdropS3FS\Relay\Attributes\RedisCommand, \BackdropS3FS\Relay\Attributes\Cached]
     ...
     * @return Relay|bool
     */
    #[\BackdropS3FS\Relay\Attributes\RedisCommand]
     ...
     */
    #[\BackdropS3FS\Relay\Attributes\RedisCommand]
    public function geosearch(string $key, array|string $position, array|int|float $shape, string $unit, array $options = []): Relay|array|false
    {
    }
    /**
     ...
     * @return Relay|string|null|false
     */
    public function xadd(string $key, string $id, array $values, int $maxlen = 0, bool $approx = \false, bool $nomkstream = \false): Relay|string|null|false
    {
    }
    /**
