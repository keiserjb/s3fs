 ...
 * @link https://php.net/manual/en/class.splfileinfo.php
 */
\class_alias('BackdropS3FS\SplFileInfo', 'SplFileInfo', \false);
/**
 ...
 * @link https://php.net/manual/en/class.directoryiterator.php
 */
\class_alias('BackdropS3FS\DirectoryIterator', 'DirectoryIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.filesystemiterator.php
 */
\class_alias('BackdropS3FS\FilesystemIterator', 'FilesystemIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.recursivedirectoryiterator.php
 */
\class_alias('BackdropS3FS\RecursiveDirectoryIterator', 'RecursiveDirectoryIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.globiterator.php
 */
\class_alias('BackdropS3FS\GlobIterator', 'GlobIterator', \false);
/**
 ...
 * @link https://php.net/manual/en/class.splfileobject.php
 */
\class_alias('BackdropS3FS\SplFileObject', 'SplFileObject', \false);
/**
 ...
 * @link https://php.net/manual/en/class.spltempfileobject.php
 */
\class_alias('BackdropS3FS\SplTempFileObject', 'SplTempFileObject', \false);
/**
 * @template TValue
...
class SplDoublyLinkedList implements \Iterator, \Countable, \ArrayAccess, \Serializable
{
     ...
     */
    #[TentativeType]
    public function setIteratorMode(
        #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')]
        $mode
    ): int
    {
 ...
 * @template-implements ArrayAccess<int, TValue>
 */
\class_alias('BackdropS3FS\SplDoublyLinkedList', 'SplDoublyLinkedList', \false);
/**
 * @template TValue
 ...
 * @link https://php.net/manual/en/class.splqueue.php
 */
\class_alias('BackdropS3FS\SplQueue', 'SplQueue', \false);
/**
 * @template TValue
 ...
 * @template-extends SplDoublyLinkedList<TValue>
 */
\class_alias('BackdropS3FS\SplStack', 'SplStack', \false);
/**
 * @template TValue
 ...
 * @template-implements Iterator<int, TValue>
 */
\class_alias('BackdropS3FS\SplHeap', 'SplHeap', \false);
/**
 * @template TValue
 ...
 * @template-extends SplHeap<TValue>
 */
\class_alias('BackdropS3FS\SplMinHeap', 'SplMinHeap', \false);
/**
 * @template TValue
 ...
 * @template-extends SplHeap<TValue>
 */
\class_alias('BackdropS3FS\SplMaxHeap', 'SplMaxHeap', \false);
/**
 * @template TPriority
 * @template TValue
...
class SplPriorityQueue implements \Iterator, \Countable
{
     ...
     */
    #[TentativeType]
    public function setExtractFlags(
        #[LanguageLevelTypeAware(['8.0' => 'int'], default: '')]
        $flags
    ): int
    {
 ...
 * @template-implements Iterator<int, TValue>
 */
\class_alias('BackdropS3FS\SplPriorityQueue', 'SplPriorityQueue', \false);
/**
 * @template TValue
 ...
 * @template-implements IteratorAggregate<int, TValue>
 */
\class_alias('BackdropS3FS\SplFixedArray', 'SplFixedArray', \false);
/**
 ...
 * @link https://php.net/manual/en/class.splobserver.php
 */
\class_alias('BackdropS3FS\SplObserver', 'SplObserver', \false);
/**
 ...
 * @link https://php.net/manual/en/class.splsubject.php
 */
\class_alias('BackdropS3FS\SplSubject', 'SplSubject', \false);
/**
...
class SplObjectStorage implements \Countable, \SeekableIterator, \Serializable, \ArrayAccess
{
    ...
    public function attach(
        #[LanguageLevelTypeAware(['8.0' => 'object'], default: '')]
        $object,
        #[LanguageLevelTypeAware(['8.0' => 'mixed'], default: '')]
        $info = null
    ): void
    ...
    public function addAll(
        #[LanguageLevelTypeAware(['8.0' => 'SplObjectStorage'], default: '')]
        $storage
    ): int
    {
    }
 ...
 * @template-implements ArrayAccess<TObject, TValue>
 */
\class_alias('BackdropS3FS\SplObjectStorage', 'SplObjectStorage', \false);
/**
...
class MultipleIterator implements \Iterator
{
    ...
    public function attachIterator(
        \Iterator $iterator,
        #[LanguageLevelTypeAware(['8.0' => 'int|string|null'], default: '')]
        $info = null
    ): void
    {
    }
 ...
 * @link https://php.net/manual/en/class.multipleiterator.php
 */
\class_alias('BackdropS3FS\MultipleIterator', 'MultipleIterator', \false);
