 ...
 */
\define("WIN32_SERVICE_CONTROL_PRESHUTDOWN", 0xf);
/**
 ...
 */
\define("WIN32_SERVICE_CONTROL_SHUTDOWN", 0x5);
/**
 *  Notifies a service that it should stop.
 */
\define("WIN32_SERVICE_CONTROL_STOP", 0x1);
 ...
 */
\define("WIN32_SERVICE_ACCEPT_PAUSE_CONTINUE", 0x2);
/**
 ...
 *  XP/2000.
 */
\define("WIN32_SERVICE_ACCEPT_PRESHUTDOWN", 0x100);
/**
 ...
 */
\define("WIN32_SERVICE_RUNS_IN_SYSTEM_PROCESS", 0x1);
 ...
 * called.
 */
\define("WIN32_ERROR_FAILED_SERVICE_CONTROLLER_CONNECT", 0x427);
/**
 * The buffer is too small for the service status structure. Nothing was written to the structure.
 */
\define("WIN32_ERROR_INSUFFICIENT_BUFFER", 0x7a);
/**
 * The specified service status structure is invalid.
 */
\define("WIN32_ERROR_INVALID_DATA", 0xd);
/**
 * The handle to the specified service control manager database is invalid.
 */
\define("WIN32_ERROR_INVALID_HANDLE", 0x6);
/**
 * The InfoLevel parameter contains an unsupported value.
 */
\define("WIN32_ERROR_INVALID_LEVEL", 0x7c);
/**
 * The specified service name is invalid.
 */
\define("WIN32_ERROR_INVALID_NAME", 0x7b);
/**
 * A parameter that was specified is invalid.
 */
\define("WIN32_ERROR_INVALID_PARAMETER", 0x57);
/**
 * The user account name specified in the user parameter does not exist. See win32_create_service().
 */
\define("WIN32_ERROR_INVALID_SERVICE_ACCOUNT", 0x421);
/**
 * The requested control code is not valid, or it is unacceptable to the service.
 */
\define("WIN32_ERROR_INVALID_SERVICE_CONTROL", 0x41c);
/**
 * The service binary file could not be found.
 */
\define("WIN32_ERROR_PATH_NOT_FOUND", 0x3);
/**
 * An instance of the service is already running.
 */
\define("WIN32_ERROR_SERVICE_ALREADY_RUNNING", 0x420);
/**
 ...
 */
\define("WIN32_ERROR_SERVICE_CANNOT_ACCEPT_CTRL", 0x425);
/**
 * The database is locked.
 */
\define("WIN32_ERROR_SERVICE_DATABASE_LOCKED", 0x41f);
/**
 * The service depends on a service that does not exist or has been marked for deletion.
 */
\define("WIN32_ERROR_SERVICE_DEPENDENCY_DELETED", 0x433);
/**
 * The service depends on another service that has failed to start.
 */
\define("WIN32_ERROR_SERVICE_DEPENDENCY_FAIL", 0x42c);
/**
 * The service has been disabled.
 */
\define("WIN32_ERROR_SERVICE_DISABLED", 0x422);
/**
 * The specified service does not exist as an installed service.
 */
\define("WIN32_ERROR_SERVICE_DOES_NOT_EXIST", 0x424);
/**
 * The specified service already exists in this database.
 */
\define("WIN32_ERROR_SERVICE_EXISTS", 0x431);
/**
 ...
 */
\define("WIN32_ERROR_SERVICE_LOGON_FAILED", 0x42d);
/**
 * The specified service has already been marked for deletion.
 */
\define("WIN32_ERROR_SERVICE_MARKED_FOR_DELETE", 0x430);
/**
 * A thread could not be created for the service.
 */
\define("WIN32_ERROR_SERVICE_NO_THREAD", 0x41e);
/**
 * The service has not been started.
 */
\define("WIN32_ERROR_SERVICE_NOT_ACTIVE", 0x426);
/**
 ...
 */
\define("WIN32_ERROR_SERVICE_REQUEST_TIMEOUT", 0x41d);
/**
 * The system is shutting down; this function cannot be called.
 */
\define("WIN32_ERROR_SHUTDOWN_IN_PROGRESS", 0x45b);
/**
 * No error.
 */
\define("WIN32_NO_ERROR", 0x0);
 ...
 */
\define("WIN32_HIGH_PRIORITY_CLASS", 0x80);
/**
 ...
 *  by child processes.
 */
\define("WIN32_IDLE_PRIORITY_CLASS", 0x40);
/**
 *  Process with no special scheduling needs.
 */
\define("WIN32_NORMAL_PRIORITY_CLASS", 0x20);
/**
 ...
 *  unresponsive.
 */
\define("WIN32_REALTIME_PRIORITY_CLASS", 0x100);
