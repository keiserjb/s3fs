...
use BackdropS3FS\JetBrains\PhpStorm\Deprecated;
use BackdropS3FS\JetBrains\PhpStorm\ExpectedValues as EV;
use BackdropS3FS\JetBrains\PhpStorm\Internal\LanguageLevelTypeAware as LanguageAware;
use BackdropS3FS\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable as ElementAvailable;
use BackdropS3FS\JetBrains\PhpStorm\Internal\TentativeType;
...
class Collator
{
    ...
    public function __construct(
        #[LanguageAware(['8.0' => 'string'], default: '')]
        $locale
    )
    {
    }
    ...
    public function sortWithSortKeys(
        array &$array,
        #[ElementAvailable(from: '5.3', to: '5.6')]
        $flags = []
    ): bool
    {
    }
...
\class_alias('BackdropS3FS\Collator', 'Collator', \false);
class NumberFormatter
{
    ...
    public function __construct(
        ...
        $locale,
        #[LanguageAware(['8.0' => 'int'], default: '')]
        #[EV([\NumberFormatter::DECIMAL, \NumberFormatter::PATTERN_DECIMAL, \NumberFormatter::PATTERN_RULEBASED, \NumberFormatter::CURRENCY, \NumberFormatter::PERCENT, \NumberFormatter::SCIENTIFIC, \NumberFormatter::SPELLOUT, \NumberFormatter::ORDINAL, \NumberFormatter::DURATION, \NumberFormatter::PATTERN_RULEBASED, \NumberFormatter::CURRENCY_ACCOUNTING, \NumberFormatter::DEFAULT_STYLE, \NumberFormatter::IGNORE])]
        $style,
        #[LanguageAware(['8.0' => 'string|null'], default: '')]
        $pattern = null
    )
    {
    }
    ...
    public static function create(
        ...
        $locale,
        #[LanguageAware(['8.0' => 'int'], default: '')]
        #[EV([\NumberFormatter::PATTERN_DECIMAL, \NumberFormatter::PATTERN_RULEBASED, \NumberFormatter::CURRENCY, \NumberFormatter::PERCENT, \NumberFormatter::SCIENTIFIC, \NumberFormatter::SPELLOUT, \NumberFormatter::ORDINAL, \NumberFormatter::DURATION, \NumberFormatter::PATTERN_RULEBASED, \NumberFormatter::CURRENCY_ACCOUNTING, \NumberFormatter::DEFAULT_STYLE, \NumberFormatter::IGNORE])]
        $style,
        #[LanguageAware(['8.0' => 'string|null'], default: '')]
        $pattern = null
    ): ?\NumberFormatter
    ...
    public function format(
        #[LanguageAware(['8.0' => 'int|float'], default: '')]
        $num,
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $type = 0
    ): string|false
    ...
    public function formatCurrency(
        #[LanguageAware(['8.0' => 'float'], default: '')]
        $amount,
        #[LanguageAware(['8.0' => 'string'], default: '')]
        $currency
    ): string|false
...
\class_alias('BackdropS3FS\NumberFormatter', 'NumberFormatter', \false);
class Normalizer
{
...
\class_alias('BackdropS3FS\Normalizer', 'Normalizer', \false);
class Locale
{
    /**
    ...
    public static function filterMatches(
        ...
        $canonicalize,
        #[ElementAvailable(from: '7.0')]
        #[LanguageAware(['8.0' => 'bool'], default: '')]
        $canonicalize = \false
    ): ?bool
    {
    }
...
\class_alias('BackdropS3FS\Locale', 'Locale', \false);
...
\class_alias('BackdropS3FS\MessageFormatter', 'MessageFormatter', \false);
class IntlDateFormatter
{
    ...
    public function __construct(
        #[LanguageAware(['8.0' => 'string|null'], default: '')]
        $locale,
        #[ElementAvailable(from: '5.3', to: '8.0')]
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $dateType,
        #[ElementAvailable(from: '5.3', to: '8.0')]
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $timeType,
        #[ElementAvailable(from: '8.1')]
        int $dateType = 0,
        #[ElementAvailable(from: '8.1')]
        int $timeType = 0,
        $timezone = null,
    ...
    public static function create(
        ...
        int $timeType = 0,
        $timezone = null,
        #[LanguageAware(['8.0' => 'IntlCalendar|int|null'], default: '')]
        $calendar = null,
        #[LanguageAware(['8.0' => 'string|null'], default: '')]
        $pattern = null
    ): ?\IntlDateFormatter
    ...
    #[TentativeType]
    public function format(
        #[ElementAvailable(from: '5.3', to: '7.4')]
        $datetime = null,
        #[ElementAvailable(from: '8.0')]
        $datetime,
        #[ElementAvailable(from: '5.3', to: '7.4')]
...
\class_alias('BackdropS3FS\IntlDateFormatter', 'IntlDateFormatter', \false);
class ResourceBundle implements \IteratorAggregate, \Countable
{
    ...
    public function get(
        #[LanguageAware(['8.4' => 'string|int'], default: '')]
        $index,
        #[LanguageAware(['8.0' => 'bool'], default: '')]
        $fallback = \true
    )
...
\class_alias('BackdropS3FS\ResourceBundle', 'ResourceBundle', \false);
/**
 * @since 5.4
 */
class Transliterator
{
    ...
    public static function create(
        ...
        $id,
        #[LanguageAware(['8.0' => 'int'], default: '')]
        #[EV([\Transliterator::FORWARD, \Transliterator::REVERSE])]
        $direction = 0
    ): ?\Transliterator
    {
    }
 ...
 * @since 5.4
 */
\class_alias('BackdropS3FS\Transliterator', 'Transliterator', \false);
/**
...
class Spoofchecker
{
     ...
     */
    #[TentativeType]
    public function setRestrictionLevel(
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $level
    ): void
    {
 ...
 * @link https://php.net/manual/en/class.spoofchecker.php
 */
\class_alias('BackdropS3FS\Spoofchecker', 'Spoofchecker', \false);
/**
 * @since 5.5
 */
 ...
 * @since 5.5
 */
\class_alias('BackdropS3FS\IntlGregorianCalendar', 'IntlGregorianCalendar', \false);
/**
 * @since 5.5
 */
class IntlCalendar
{
    ...
    public function clear(
        #[LanguageAware(['8.0' => 'int|null'], default: '')]
        $field = null
    )
    {
    }
    ...
    public function equals(
        #[LanguageAware(['8.0' => 'IntlCalendar'], default: '')]
        $other
    ): bool
    {
    }
    ...
    public static function fromDateTime(
        #[LanguageAware(['8.0' => 'DateTime|string'], default: '')]
        $datetime,
        #[LanguageAware(['8.0' => 'string|null'], default: '')]
        #[ElementAvailable(from: '8.0')]
        $locale
    ...
    #[Pure]
    #[TentativeType]
    public function getActualMaximum(
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $field
    ): int|false
    {
    ...
    #[Pure]
    #[TentativeType]
    public function getActualMinimum(
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $field
    ): int|false
    {
    ...
    #[Pure]
    #[TentativeType]
    public function getGreatestMinimum(
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $field
    ): int|false
    {
    ...
    #[Pure]
    #[TentativeType]
    public function getLeastMaximum(
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $field
    ): int|false
    {
    ...
    public function isWeekend(
        #[LanguageAware(['8.0' => 'float|null'], default: '')]
        $timestamp = null
    ): bool
    {
    }
     ...
     */
    #[TentativeType]
    public function PS_UNRESERVE_PREFIX_isSet(
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $field
    ): bool
    {
 ...
 * @since 5.5
 */
\class_alias('BackdropS3FS\IntlCalendar', 'IntlCalendar', \false);
/**
 * @since 5.5
 */
 ...
 * @since 5.5
 */
\class_alias('BackdropS3FS\IntlIterator', 'IntlIterator', \false);
/**
 * @since 5.5
 */
 ...
 * @since 5.5
 */
\class_alias('BackdropS3FS\IntlException', 'IntlException', \false);
/**
 * @since 5.5
 */
class IntlTimeZone
{
    ...
    public static function fromDateTimeZone(
        #[LanguageAware(['8.0' => 'DateTimeZone'], default: '')]
        $timezone
    ): ?\IntlTimeZone
    {
    }
 ...
 * @since 5.5
 */
\class_alias('BackdropS3FS\IntlTimeZone', 'IntlTimeZone', \false);
/**
 * (PHP 5 &gt;= 5.3.0, PECL intl &gt;= 1.0.0)<br/>
 * Create a collator
 * @link https://php.net/manual/en/collator.create.php
...
function numfmt_create(
    string $locale,
    int $style,
    #[LanguageAware(['8.0' => 'string|null'], default: 'string')]
    $pattern = null
): ?\NumberFormatter
{
}
...
function datefmt_format(
    #[LanguageAware(['8.0' => 'IntlDateFormatter'], default: '')]
    #[ElementAvailable(from: '5.3', to: '7.4')]
    $formatter = null,
    #[LanguageAware(['8.0' => 'IntlDateFormatter'], default: '')]
    #[ElementAvailable(from: '8.0')]
...
function intltz_has_same_rules(
    ...
    #[ElementAvailable(from: '5.5', to: '7.4')]
    \IntlTimeZone $other = null,
    #[ElementAvailable(from: '8.0')]
    \IntlTimeZone $other
): bool
{
 ...
 */
#[Pure]
function resourcebundle_create(?string $locale, ?string $bundle, bool $fallback = \true): ?\ResourceBundle
{
}
/**
 * (PHP &gt;= 5.3.2, PECL intl &gt;= 2.0.0)<br/>
...
#[Pure]
#[LanguageAware(['8.4' => 'ResourceBundle|array|string|int|null'], default: 'mixed')]
function resourcebundle_get(\ResourceBundle $bundle, string|int $index, bool $fallback = \true)
{
}
/**
 * (PHP &gt;= 5.3.2, PECL intl &gt;= 2.0.0)<br/>
...
class IntlBreakIterator implements \IteratorAggregate
{
    ...
    public function getPartsIterator(
        #[LanguageAware(['8.0' => 'int', '8.3' => 'string'], default: '')]
 ...
 * @since 5.5
 */
\class_alias('BackdropS3FS\IntlBreakIterator', 'IntlBreakIterator', \false);
...
\class_alias('BackdropS3FS\IntlRuleBasedBreakIterator', 'IntlRuleBasedBreakIterator', \false);
/**
 ...
 * @since 5.5
 */
\class_alias('BackdropS3FS\IntlPartsIterator', 'IntlPartsIterator', \false);
...
\class_alias('BackdropS3FS\IntlCodePointBreakIterator', 'IntlCodePointBreakIterator', \false);
class UConverter
{
    /* Constants */
    ...
    public function fromUCallback(
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $reason,
        #[LanguageAware(['8.0' => 'array'], default: '')]
        $source,
        #[LanguageAware(['8.0' => 'int'], default: '')]
        $codePoint,
        &$error
    ...
    public static function getAliases(
        #[ElementAvailable(from: '5.5', to: '5.6')]
        $name = '',
        #[ElementAvailable(from: '7.0')]
        #[LanguageAware(['8.0' => 'string'], default: '')]
        $name
    ...
    public static function transcode(
        ...
        #[LanguageAware(['8.0' => 'string'], default: '')]
        $fromEncoding,
        #[LanguageAware(['8.0' => 'array|null'], default: '')]
        $options = null
    ): string|false
    {
    }
}
\class_alias('BackdropS3FS\UConverter', 'UConverter', \false);
// End of intl v.1.1.0
