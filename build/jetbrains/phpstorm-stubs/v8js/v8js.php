...
class V8Js
{
     ...
     */
    public function __construct($object_name = "PHP", array $variables = [], array $extensions = [], $report_uncaught_exceptions = \true, $snapshot_blob = null)
    {
    }
    /**
...
\class_alias('BackdropS3FS\V8Js', 'V8Js', \false);
...
\class_alias('BackdropS3FS\V8JsScriptException', 'V8JsScriptException', \false);
final class V8JsTimeLimitException extends \Exception
{
}
\class_alias('BackdropS3FS\V8JsTimeLimitException', 'V8JsTimeLimitException', \false);
final class V8JsMemoryLimitException extends \Exception
{
}
\class_alias('BackdropS3FS\V8JsMemoryLimitException', 'V8JsMemoryLimitException', \false);
