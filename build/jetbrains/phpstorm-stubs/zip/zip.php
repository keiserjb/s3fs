...
class ZipArchive implements \Countable
{
     ...
     */
    #[TentativeType]
    public function setArchiveComment(
        #[LanguageLevelTypeAware(['8.0' => 'string'], default: '')]
        $comment
    ): bool
    {
    ...
    public function setArchiveFlag(
        #[LanguageLevelTypeAware(['8.3' => 'int'], default: '')]
        $flag,
        #[LanguageLevelTypeAware(['8.3' => 'int'], default: '')]
        $value
    )
    ...
    public function getStreamName(
        #[LanguageLevelTypeAware(['8.2' => 'string'], default: '')]
        $name,
 ...
 * @link https://php.net/manual/en/class.ziparchive.php
 */
\class_alias('BackdropS3FS\ZipArchive', 'ZipArchive', \false);
/**
