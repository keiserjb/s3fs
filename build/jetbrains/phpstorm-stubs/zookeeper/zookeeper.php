 ...
 * @link https://www.php.net/manual/en/class.zookeeper.php
 */
\class_alias('BackdropS3FS\Zookeeper', 'Zookeeper', \false);
class ZookeeperException extends \Exception
{
}
\class_alias('BackdropS3FS\ZookeeperException', 'ZookeeperException', \false);
class ZookeeperOperationTimeoutException extends \ZookeeperException
{
}
\class_alias('BackdropS3FS\ZookeeperOperationTimeoutException', 'ZookeeperOperationTimeoutException', \false);
class ZookeeperConnectionException extends \ZookeeperException
{
}
\class_alias('BackdropS3FS\ZookeeperConnectionException', 'ZookeeperConnectionException', \false);
class ZookeeperMarshallingException extends \ZookeeperException
{
}
\class_alias('BackdropS3FS\ZookeeperMarshallingException', 'ZookeeperMarshallingException', \false);
class ZookeeperAuthenticationException extends \ZookeeperException
{
}
\class_alias('BackdropS3FS\ZookeeperAuthenticationException', 'ZookeeperAuthenticationException', \false);
class ZookeeperSessionException extends \ZookeeperException
{
}
\class_alias('BackdropS3FS\ZookeeperSessionException', 'ZookeeperSessionException', \false);
class ZookeeperNoNodeException extends \ZookeeperException
{
}
\class_alias('BackdropS3FS\ZookeeperNoNodeException', 'ZookeeperNoNodeException', \false);
