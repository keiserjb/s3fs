...
namespace BackdropS3FS\Aws\Sts\RegionalEndpoints;

use BackdropS3FS\Aws\AbstractConfigurationProvider;
use BackdropS3FS\Aws\CacheInterface;
use BackdropS3FS\Aws\ConfigurationProviderInterface;
use BackdropS3FS\Aws\Sts\RegionalEndpoints\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use ($profile, $filename) {
            ...
            $data = \BackdropS3FS\Aws\parse_ini_file($filename, \true);
            if ($data === \false) {
