...
use BackdropS3FS\Aws\Auth\AuthSelectionMiddleware;
use BackdropS3FS\Aws\Auth\AuthSchemeResolverInterface;
use BackdropS3FS\Aws\EndpointDiscovery\EndpointDiscoveryMiddleware;
use BackdropS3FS\Aws\EndpointV2\EndpointProviderV2;
use BackdropS3FS\Aws\EndpointV2\EndpointV2Middleware;
...
class AwsClient implements AwsClientInterface
{
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \BackdropS3FS\Aws\load_compiled_json($file);
    ...
    {
        $aliases = \BackdropS3FS\Aws\load_compiled_json(__DIR__ . '/data/aliases.json');
