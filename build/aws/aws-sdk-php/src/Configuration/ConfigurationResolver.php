...
namespace BackdropS3FS\Aws\Configuration;
...
class ConfigurationResolver
{
    ...
    {
        if ($type === 'bool' && !is_null($convertedValue = \BackdropS3FS\Aws\boolean_value($value))) {
    ...
    private static function retrieveValueFromIniSubsection($data, $profile, $filename, $expectedType, $options)
    {
        ...
        $services_section = \BackdropS3FS\Aws\parse_ini_section_with_subsections($filename, "services {$data[$profile]['services']}");
