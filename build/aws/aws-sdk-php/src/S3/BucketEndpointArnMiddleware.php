...
use BackdropS3FS\Aws\Arn\ObjectLambdaAccessPointArn;
use BackdropS3FS\Aws\Arn\Exception\InvalidArnException;
use BackdropS3FS\Aws\Arn\AccessPointArn as BaseAccessPointArn;
use BackdropS3FS\Aws\Arn\S3\OutpostsAccessPointArn;
use BackdropS3FS\Aws\Arn\S3\MultiRegionAccessPointArn;
...
class BucketEndpointArnMiddleware
{
    ...
    private function generateAccessPointHost(BaseAccessPointArn $arn, RequestInterface $req)
    {
        ...
        $region = \BackdropS3FS\Aws\strip_fips_pseudo_regions($region);
