...
use BackdropS3FS\Aws\LruArrayCache;
use BackdropS3FS\Aws\Result;
use BackdropS3FS\Aws\S3\Exception\S3Exception;
use BackdropS3FS\GuzzleHttp\Psr7;
use BackdropS3FS\GuzzleHttp\Psr7\Stream;
use BackdropS3FS\GuzzleHttp\Psr7\CachingStream;
...
class StreamWrapper
{
    ...
    public function dir_opendir($path, $options)
    {
        ...
        $this->objectIterator = \BackdropS3FS\Aws\flatmap($this->getClient()->getPaginator('ListObjects', $op), function (Result $result) use ($filterFn) {
