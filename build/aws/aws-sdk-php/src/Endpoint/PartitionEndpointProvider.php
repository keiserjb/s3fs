...
namespace BackdropS3FS\Aws\Endpoint;

use BackdropS3FS\JmesPath\Env;
class PartitionEndpointProvider
{
    ...
    {
        $data = \BackdropS3FS\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \BackdropS3FS\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
