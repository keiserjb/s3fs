...
namespace BackdropS3FS\Aws\Endpoint\UseDualstackEndpoint;
...
use BackdropS3FS\Aws\Endpoint\UseDualstackEndpoint\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($region, $profile = null, $filename = null)
    {
        ...
        return function () use ($region, $profile, $filename) {
            ...
            $data = \BackdropS3FS\Aws\parse_ini_file($filename, \true, \INI_SCANNER_NORMAL);
            if ($data === \false) {
