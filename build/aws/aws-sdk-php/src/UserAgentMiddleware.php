...
use BackdropS3FS\Aws\EndpointDiscovery\Configuration;
use Closure;
...
class UserAgentMiddleware
{
    ...
    private function requestWithUserAgentHeader(RequestInterface $request): RequestInterface
    {
        ...
        return $request->withHeader('User-Agent', implode(' ', array_merge($userAgentValue, $request->getHeader('User-Agent'))));
    }
    /**
