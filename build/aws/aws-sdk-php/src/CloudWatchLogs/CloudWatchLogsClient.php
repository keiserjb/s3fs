...
namespace BackdropS3FS\Aws\CloudWatchLogs;
...
{
    static $streamingCommands = ['StartLiveTail' => \true];
    ...
    {
        $this->getHandlerList()->appendInit($this->getStreamingFlagMiddleware(), 'streaming-flag-middleware');
    }
