...
use BackdropS3FS\AWS\CRT\Auth\Signable;
use BackdropS3FS\AWS\CRT\Auth\SignatureType;
use BackdropS3FS\AWS\CRT\Auth\SignedBodyHeaderType;
use BackdropS3FS\AWS\CRT\Auth\Signing;
use BackdropS3FS\AWS\CRT\Auth\SigningAlgorithm;
use BackdropS3FS\AWS\CRT\Auth\SigningConfigAWS;
use BackdropS3FS\AWS\CRT\Auth\StaticCredentialsProvider;
use BackdropS3FS\AWS\CRT\HTTP\Request;
use BackdropS3FS\Aws\Exception\CommonRuntimeException;
use BackdropS3FS\Aws\Exception\CouldNotCreateChecksumException;
...
{
    use SignatureTrait;
    const ISO8601_BASIC = 'BackdropS3FS\Ymd\THis\Z';
