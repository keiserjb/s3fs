...
namespace BackdropS3FS\Aws\Api;

use BackdropS3FS\Aws\Exception\UnresolvedApiException;
/**
 * API providers.
 *
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \BackdropS3FS\Aws\manifest());
    }
    /**
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \BackdropS3FS\Aws\load_compiled_json($path);
