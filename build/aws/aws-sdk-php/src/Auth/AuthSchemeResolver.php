...
use BackdropS3FS\Aws\Auth\Exception\UnresolvedAuthSchemeException;
use BackdropS3FS\Aws\Exception\CredentialsException;
use BackdropS3FS\Aws\Exception\TokenException;
use BackdropS3FS\Aws\Identity\AwsCredentialIdentity;
use BackdropS3FS\Aws\Identity\BearerTokenIdentity;
