 ...
 */
namespace BackdropS3FS\Symfony\Component\Console\Attribute;
...
use BackdropS3FS\Symfony\Component\String\UnicodeString;
...
class Option
{
     ...
     */
    public function __construct(public string $description = '', public string $name = '', public array|string|null $shortcut = null, array|callable $suggestedValues = [])
    {
    ...
    {
        $types = array_map(static fn(\ReflectionType $t) => $t instanceof \ReflectionNamedType ? $t->getName() : null, $type->getTypes());
        sort($types);
