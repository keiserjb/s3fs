 ...
 */
namespace BackdropS3FS\Symfony\Component\Console\Question;
...
class ChoiceQuestion extends Question
{
     ...
     */
    public function __construct(string $question, private array $choices, string|bool|int|float|null $default = null)
    {
        if (!$choices) {
