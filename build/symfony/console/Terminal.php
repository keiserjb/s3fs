...
use BackdropS3FS\Symfony\Component\Console\Output\AnsiColorMode;
class Terminal
{
    ...
    public static function hasSttyAvailable(): bool
    {
        ...
        if (!\function_exists('shell_exec') && !\function_exists('BackdropS3FS\shell_exec')) {
            return \false;
        }
    ...
    {
        if (!\function_exists('proc_open') && !\function_exists('BackdropS3FS\proc_open')) {
            return null;
        }
