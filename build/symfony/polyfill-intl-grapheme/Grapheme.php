 ...
 */
namespace BackdropS3FS\Symfony\Polyfill\Intl\Grapheme;

\define('BackdropS3FS\SYMFONY_GRAPHEME_CLUSTER_RX', ((float) \PCRE_VERSION < 10 ? (float) \PCRE_VERSION >= 8.32 : (float) \PCRE_VERSION >= 10.39) ? '\X' : Grapheme::GRAPHEME_CLUSTER_RX);
/**
