...
use BackdropS3FS\Symfony\Component\ErrorHandler\Exception\FlattenException;
use BackdropS3FS\Symfony\Component\ErrorHandler\Exception\SilencedErrorContext;
        ...
        if (isset($f['file'], $f['line'])) {
            ...
            if (isset(self::$framesCache[$cacheKey])) {
                ...
                if (is_file($f['file']) && 0 <= self::$srcContext) {
                    if (!empty($f['class']) && is_subclass_of($f['class'], 'BackdropS3FS\Twig\Template')) {
                        $template = null;
                        if (isset($f['object'])) {
                            $template = $f['object'];
