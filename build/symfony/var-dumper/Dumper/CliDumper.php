...
use BackdropS3FS\Symfony\Component\VarDumper\Cloner\Cursor;
...
class CliDumper extends AbstractDumper
{
    ...
    protected static string $unicodeCharsRx = "/[ ­͏؜ᅟᅠ឴឵᠎ -‏  ⁠-⁤⁪-⁯　⠀ㅤ﻿ﾠ𝅙𝅳-𝅺]/u";
    ...
    protected function dumpKey(Cursor $cursor): void
    {
        if (null !== $key = $cursor->hashKey) {
            ...
            $attr = ['binary' => $cursor->hashKeyIsBinary, 'virtual' => $cursor->attr['virtual'] ?? \false];
