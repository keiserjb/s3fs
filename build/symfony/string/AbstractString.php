 ...
 */
namespace BackdropS3FS\Symfony\Component\String;

use BackdropS3FS\Symfony\Component\String\Exception\ExceptionInterface;
use BackdropS3FS\Symfony\Component\String\Exception\InvalidArgumentException;
use BackdropS3FS\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractString implements \Stringable, \JsonSerializable
{
    ...
    public function toByteString(?string $toEncoding = null): ByteString
    {
        ...
        try {
            ...
            if (!\function_exists('iconv') && !\function_exists('BackdropS3FS\iconv')) {
