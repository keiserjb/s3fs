 ...
 */
namespace BackdropS3FS\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'BackdropS3FS\mes\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'BackdropS3FS\Mes\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'BackdropS3FS\ma\1'],
        ['/^Mes(dame|demoiselle)s$/', 'BackdropS3FS\Ma\1'],
        ['/^mes(sieur|seigneur)s$/', 'BackdropS3FS\mon\1'],
        ['/^Mes(sieur|seigneur)s$/', 'BackdropS3FS\Mon\1'],
        // Default rule
        ['/s$/i', ''],
    ];
