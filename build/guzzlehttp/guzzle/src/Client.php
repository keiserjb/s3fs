...
use BackdropS3FS\GuzzleHttp\Cookie\CookieJar;
use BackdropS3FS\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \BackdropS3FS\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
