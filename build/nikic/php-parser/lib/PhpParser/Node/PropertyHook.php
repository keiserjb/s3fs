...
use BackdropS3FS\PhpParser\Modifiers;
use BackdropS3FS\PhpParser\Node\Expr\Assign;
use BackdropS3FS\PhpParser\Node\Expr\PropertyFetch;
use BackdropS3FS\PhpParser\Node\Expr\Variable;
use BackdropS3FS\PhpParser\Node\Stmt\Expression;
use BackdropS3FS\PhpParser\Node\Stmt\Return_;
