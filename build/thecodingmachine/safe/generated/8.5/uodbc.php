...
use BackdropS3FS\Safe\Exceptions\UodbcException;
/**
 ...
 *
 */
function odbc_autocommit(\BackdropS3FS\Odbc\Connection $odbc, ?bool $enable = null)
{
    error_clear_last();
    if ($enable !== null) {
 ...
 *
 */
function odbc_columnprivileges(\BackdropS3FS\Odbc\Connection $odbc, string $catalog, string $schema, string $table, string $column)
{
    error_clear_last();
 ...
 *
 */
function odbc_columns(\BackdropS3FS\Odbc\Connection $odbc, ?string $catalog = null, ?string $schema = null, ?string $table = null, ?string $column = null)
{
    error_clear_last();
    if ($column !== null) {
 ...
 *
 */
function odbc_commit(\BackdropS3FS\Odbc\Connection $odbc): void
{
    error_clear_last();
 ...
 *
 */
function odbc_connect(string $dsn, ?string $user = null, ?string $password = null, int $cursor_option = \SQL_CUR_USE_DRIVER): \BackdropS3FS\Odbc\Connection
{
    error_clear_last();
 ...
 *
 */
function odbc_cursor(\BackdropS3FS\Odbc\Result $statement): string
{
    error_clear_last();
 ...
 *
 */
function odbc_data_source(\BackdropS3FS\Odbc\Connection $odbc, int $fetch_type): array
{
    error_clear_last();
 ...
 *
 */
function odbc_exec(\BackdropS3FS\Odbc\Connection $odbc, string $query): \BackdropS3FS\Odbc\Result
{
    error_clear_last();
 ...
 *
 */
function odbc_execute(\BackdropS3FS\Odbc\Result $statement, array $params = []): void
{
    error_clear_last();
 ...
 *
 */
function odbc_fetch_into(\BackdropS3FS\Odbc\Result $statement, ?array &$array, ?int $row = null): int
{
    error_clear_last();
    if ($row !== null) {
 ...
 *
 */
function odbc_field_len(\BackdropS3FS\Odbc\Result $statement, int $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_name(\BackdropS3FS\Odbc\Result $statement, int $field): string
{
    error_clear_last();
 ...
 *
 */
function odbc_field_num(\BackdropS3FS\Odbc\Result $statement, string $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_scale(\BackdropS3FS\Odbc\Result $statement, int $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_type(\BackdropS3FS\Odbc\Result $statement, int $field): string
{
    error_clear_last();
 ...
 *
 */
function odbc_foreignkeys(\BackdropS3FS\Odbc\Connection $odbc, string $pk_catalog, string $pk_schema, string $pk_table, string $fk_catalog, string $fk_schema, string $fk_table)
{
    error_clear_last();
 ...
 *
 */
function odbc_gettypeinfo(\BackdropS3FS\Odbc\Connection $odbc, int $data_type = 0)
{
    error_clear_last();
 ...
 *
 */
function odbc_longreadlen(\BackdropS3FS\Odbc\Result $statement, int $length): bool
{
    error_clear_last();
 ...
 *
 */
function odbc_num_fields(\BackdropS3FS\Odbc\Result $statement): int
{
    error_clear_last();
 ...
 *
 */
function odbc_pconnect(string $dsn, ?string $user = null, ?string $password = null, int $cursor_option = \SQL_CUR_USE_DRIVER): \BackdropS3FS\Odbc\Connection
{
    error_clear_last();
    if ($cursor_option !== \SQL_CUR_USE_DRIVER) {
 ...
 *
 */
function odbc_prepare(\BackdropS3FS\Odbc\Connection $odbc, string $query): \BackdropS3FS\Odbc\Result
{
    error_clear_last();
 ...
 *
 */
function odbc_primarykeys(\BackdropS3FS\Odbc\Connection $odbc, string $catalog, string $schema, string $table)
{
    error_clear_last();
 ...
 *
 */
function odbc_procedures($odbc, ?string $catalog = null, ?string $schema = null, ?string $procedure = null): \BackdropS3FS\Odbc\Result
{
    error_clear_last();
    if ($procedure !== null) {
 ...
 *
 */
function odbc_result_all(\BackdropS3FS\Odbc\Result $statement, string $format = ""): int
{
    error_clear_last();
 ...
 *
 */
function odbc_result(\BackdropS3FS\Odbc\Result $statement, $field)
{
    error_clear_last();
 ...
 *
 */
function odbc_rollback(\BackdropS3FS\Odbc\Connection $odbc): void
{
    error_clear_last();
 ...
 *
 */
function odbc_specialcolumns(\BackdropS3FS\Odbc\Connection $odbc, int $type, string $catalog, string $schema, string $table, int $scope, int $nullable)
{
    error_clear_last();
 ...
 *
 */
function odbc_statistics(\BackdropS3FS\Odbc\Connection $odbc, string $catalog, string $schema, string $table, int $unique, int $accuracy)
{
    error_clear_last();
 ...
 *
 */
function odbc_tableprivileges(\BackdropS3FS\Odbc\Connection $odbc, string $catalog, string $schema, string $table)
{
    error_clear_last();
 ...
 *
 */
function odbc_tables(\BackdropS3FS\Odbc\Connection $odbc, ?string $catalog = null, ?string $schema = null, ?string $table = null, ?string $types = null): \BackdropS3FS\Odbc\Result
{
    error_clear_last();
    if ($types !== null) {
