...
use BackdropS3FS\Safe\Exceptions\RnpException;
/**
 ...
 *
 */
function rnp_decrypt(\BackdropS3FS\RnpFFI $ffi, string $input): string
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_decrypt($ffi, $input);
    if ($safeResult === \false) {
...
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_dump_packets_to_json($input, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_dump_packets($input, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_ffi_create(string $pub_format, string $sec_format): \BackdropS3FS\RnpFFI
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_ffi_create($pub_format, $sec_format);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_ffi_set_pass_provider(\BackdropS3FS\RnpFFI $ffi, callable $password_callback): void
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_ffi_set_pass_provider($ffi, $password_callback);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
 ...
 *
 */
function rnp_import_keys(\BackdropS3FS\RnpFFI $ffi, string $input, int $flags): string
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_import_keys($ffi, $input, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_import_signatures(\BackdropS3FS\RnpFFI $ffi, string $input, int $flags): string
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_import_signatures($ffi, $input, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_key_export_autocrypt(\BackdropS3FS\RnpFFI $ffi, string $key_fp, string $subkey_fp, string $uid, int $flags): string
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_key_export_autocrypt($ffi, $key_fp, $subkey_fp, $uid, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_key_export_revocation(\BackdropS3FS\RnpFFI $ffi, string $key_fp, int $flags, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \BackdropS3FS\rnp_key_export_revocation($ffi, $key_fp, $flags, $options);
    } else {
        $safeResult = \BackdropS3FS\rnp_key_export_revocation($ffi, $key_fp, $flags);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_key_export(\BackdropS3FS\RnpFFI $ffi, string $key_fp, int $flags): string
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_key_export($ffi, $key_fp, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_key_get_info(\BackdropS3FS\RnpFFI $ffi, string $key_fp): array
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_key_get_info($ffi, $key_fp);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_key_remove(\BackdropS3FS\RnpFFI $ffi, string $key_fp, int $flags): void
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_key_remove($ffi, $key_fp, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
 ...
 *
 */
function rnp_key_revoke(\BackdropS3FS\RnpFFI $ffi, string $key_fp, int $flags, ?array $options = null): void
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \BackdropS3FS\rnp_key_revoke($ffi, $key_fp, $flags, $options);
    } else {
        $safeResult = \BackdropS3FS\rnp_key_revoke($ffi, $key_fp, $flags);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_list_keys(\BackdropS3FS\RnpFFI $ffi, string $identifier_type): array
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_list_keys($ffi, $identifier_type);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_load_keys_from_path(\BackdropS3FS\RnpFFI $ffi, string $format, string $input_path, int $flags): void
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_load_keys_from_path($ffi, $format, $input_path, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
 ...
 *
 */
function rnp_load_keys(\BackdropS3FS\RnpFFI $ffi, string $format, string $input, int $flags): void
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_load_keys($ffi, $format, $input, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
 ...
 *
 */
function rnp_locate_key(\BackdropS3FS\RnpFFI $ffi, string $identifier_type, string $identifier): string
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_locate_key($ffi, $identifier_type, $identifier);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_op_encrypt(\BackdropS3FS\RnpFFI $ffi, string $message, array $recipient_keys_fp, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \BackdropS3FS\rnp_op_encrypt($ffi, $message, $recipient_keys_fp, $options);
    } else {
        $safeResult = \BackdropS3FS\rnp_op_encrypt($ffi, $message, $recipient_keys_fp);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_op_generate_key(\BackdropS3FS\RnpFFI $ffi, string $userid, string $key_alg, ?string $sub_alg = null, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \BackdropS3FS\rnp_op_generate_key($ffi, $userid, $key_alg, $sub_alg, $options);
    } elseif ($sub_alg !== null) {
        $safeResult = \BackdropS3FS\rnp_op_generate_key($ffi, $userid, $key_alg, $sub_alg);
    } else {
        $safeResult = \BackdropS3FS\rnp_op_generate_key($ffi, $userid, $key_alg);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_op_sign_cleartext(\BackdropS3FS\RnpFFI $ffi, string $data, array $keys_fp, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \BackdropS3FS\rnp_op_sign_cleartext($ffi, $data, $keys_fp, $options);
    } else {
        $safeResult = \BackdropS3FS\rnp_op_sign_cleartext($ffi, $data, $keys_fp);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_op_sign_detached(\BackdropS3FS\RnpFFI $ffi, string $data, array $keys_fp, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \BackdropS3FS\rnp_op_sign_detached($ffi, $data, $keys_fp, $options);
    } else {
        $safeResult = \BackdropS3FS\rnp_op_sign_detached($ffi, $data, $keys_fp);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_op_sign(\BackdropS3FS\RnpFFI $ffi, string $data, array $keys_fp, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \BackdropS3FS\rnp_op_sign($ffi, $data, $keys_fp, $options);
    } else {
        $safeResult = \BackdropS3FS\rnp_op_sign($ffi, $data, $keys_fp);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_op_verify_detached(\BackdropS3FS\RnpFFI $ffi, string $data, string $signature): array
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_op_verify_detached($ffi, $data, $signature);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_op_verify(\BackdropS3FS\RnpFFI $ffi, string $data): array
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_op_verify($ffi, $data);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_save_keys_to_path(\BackdropS3FS\RnpFFI $ffi, string $format, string $output_path, int $flags): void
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_save_keys_to_path($ffi, $format, $output_path, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
 ...
 *
 */
function rnp_save_keys(\BackdropS3FS\RnpFFI $ffi, string $format, string &$output, int $flags): void
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_save_keys($ffi, $format, $output, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \BackdropS3FS\rnp_supported_features($type);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
