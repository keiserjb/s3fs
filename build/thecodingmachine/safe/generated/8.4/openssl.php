 ...
 *
 */
function openssl_csr_get_public_key($csr, bool $short_names = \true): \OpenSSLAsymmetricKey
{
    error_clear_last();
 ...
 * @return \OpenSSLCertificateSigningRequest|bool Returns the CSR on success, TRUE if CSR creation is
