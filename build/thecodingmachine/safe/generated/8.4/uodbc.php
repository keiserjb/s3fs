 ...
 *
 */
function odbc_connect(string $dsn, string $user, string $password, int $cursor_option = \SQL_CUR_USE_DRIVER): \BackdropS3FS\Odbc\Connection
{
    error_clear_last();
 ...
 *
 */
function odbc_pconnect(string $dsn, string $user, string $password, int $cursor_option = \SQL_CUR_USE_DRIVER): \BackdropS3FS\Odbc\Connection
{
    error_clear_last();
