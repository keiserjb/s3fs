...
use BackdropS3FS\Safe\Exceptions\DatetimeException;
/**
...
class DateTimeImmutable extends \DateTimeImmutable
{
    ...
    public static function createFromRegular(\DateTimeImmutable $datetime): self
    {
        ...
        //we need to also update the wrapper to not break the operators '<' and '>'
        $safeDatetime->innerDateTime = $datetime;
        //to make sure we don't lose information because of the format().
        return $safeDatetime;
    }
    ...
    public function modify($modify): self
    {
        ...
        //we have to recreate a safe datetime because modify create a new instance of \DateTimeImmutable
    }
    /**
     * @param int $year
     * @param int $month
